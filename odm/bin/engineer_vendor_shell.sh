...
function doAddRadioFile(){
    ...
    if [[ -d /mnt/vendor/oplusreserve/radio ]]; then
        if [[ ! -f /mnt/vendor/oplusreserve/radio/esim_status.config ]]; then
            touch /mnt/vendor/oplusreserve/radio/esim_status.config
        fi

        chown radio system /mnt/vendor/oplusreserve/radio/esim_status.config

        chmod 0660 /mnt/vendor/oplusreserve/radio/esim_status.config
